...
/datum/dna/proc/generate_unique_identity()
	...
	if(ishuman(holder))
		...
		L[DNA_HAIRSTYLE_BLOCK] = construct_block(SSaccessories.find_entry(H.hairstyle, "hairstyles"), SSaccessories.get_length("hairstyles"))
		L[DNA_HAIR_COLOR_BLOCK] = sanitize_hexcolor(H.hair_color, include_crunch = FALSE)
		L[DNA_FACIAL_HAIRSTYLE_BLOCK] = construct_block(SSaccessories.find_entry(H.facial_hairstyle, "facial_hairstyles"), SSaccessories.get_length("facial_hairstyles"))
...
/datum/dna/proc/generate_unique_features()
	...
	if(features["body_markings"])
		L[DNA_LIZARD_MARKINGS_BLOCK] = construct_block(SSaccessories.find_entry(features["body_markings"], "body_markings"), SSaccessories.get_length("body_markings"))
	if(features[MUTANT_TAIL])
		L[DNA_TAIL_BLOCK] = construct_block(SSaccessories.find_entry(features[MUTANT_TAIL], MUTANT_TAIL), SSaccessories.get_length(MUTANT_TAIL))
	if(features["tail_lizard"])
		L[DNA_LIZARD_TAIL_BLOCK] = construct_block(SSaccessories.find_entry(features["tail_lizard"], "tail_lizard"), SSaccessories.get_length("tail_lizard"))
	if(features["snout"])
		L[DNA_SNOUT_BLOCK] = construct_block(SSaccessories.find_entry(features["snout"], "snout"), SSaccessories.get_length("snout"))
	if(features["horns"])
		L[DNA_HORNS_BLOCK] = construct_block(SSaccessories.find_entry(features["horns"], "horns"), SSaccessories.get_length("horns"))
	if(features["frills"])
		L[DNA_FRILLS_BLOCK] = construct_block(SSaccessories.find_entry(features["frills"], "frills"), SSaccessories.get_length("frills"))
	if(features["spines"])
		L[DNA_SPINES_BLOCK] = construct_block(SSaccessories.find_entry(features["spines"], "spines"), SSaccessories.get_length("spines"))
	if(features["ears"])
		L[DNA_EARS_BLOCK] = construct_block(SSaccessories.find_entry(features["ears"], "ears"), SSaccessories.get_length("ears"))
	if(features["moth_wings"] != "Burnt Off")
		L[DNA_MOTH_WINGS_BLOCK] = construct_block(SSaccessories.find_entry(features["moth_wings"], "moth_wings"), SSaccessories.get_length("moth_wings"))
	if(features["moth_antennae"] != "Burnt Off")
		L[DNA_MOTH_ANTENNAE_BLOCK] = construct_block(SSaccessories.find_entry(features["moth_antennae"], "moth_antennae"), SSaccessories.get_length("moth_antennae"))
	if(features["moth_markings"])
		L[DNA_MOTH_MARKINGS_BLOCK] = construct_block(SSaccessories.find_entry(features["moth_markings"], "moth_markings"), SSaccessories.get_length("moth_markings"))
	if(features["caps"])
		L[DNA_MUSHROOM_CAPS_BLOCK] = construct_block(SSaccessories.find_entry(features["caps"], "caps"), SSaccessories.get_length("caps"))
	if(features["pod_hair"])
		L[DNA_POD_HAIR_BLOCK] = construct_block(SSaccessories.find_entry(features["pod_hair"], "pod_hair"), SSaccessories.get_length("pod_hair"))
...
/datum/dna/proc/update_ui_block(blocknumber)
	...
	switch(blocknumber)
		...
		if(DNA_FACIAL_HAIRSTYLE_BLOCK)
			set_uni_identity_block(blocknumber, construct_block(SSaccessories.find_entry(H.facial_hairstyle, "facial_hairstyle"), SSaccessories.get_length("facial_hairstyle")))
		if(DNA_HAIRSTYLE_BLOCK)
			set_uni_identity_block(blocknumber, construct_block(SSaccessories.find_entry(H.hairstyle, "hairstyle"), SSaccessories.get_length("hairstyle")))
...
/datum/dna/proc/update_uf_block(blocknumber)
	...
	switch(blocknumber)
		if(DNA_LIZARD_MARKINGS_BLOCK)
			set_uni_feature_block(blocknumber, construct_block(SSaccessories.find_entry(features["body_markings"], "body_markings"), SSaccessories.get_length("body_markings")))
		if(DNA_TAIL_BLOCK)
			set_uni_feature_block(blocknumber, construct_block(SSaccessories.find_entry(features[MUTANT_LIZARD_TAIL], MUTANT_LIZARD_TAIL), SSaccessories.get_length(MUTANT_LIZARD_TAIL)))
		if(DNA_SNOUT_BLOCK)
			set_uni_feature_block(blocknumber, construct_block(SSaccessories.find_entry(features[MUTANT_SNOUT], MUTANT_SNOUT), SSaccessories.get_length(MUTANT_SNOUT)))
		if(DNA_HORNS_BLOCK)
			set_uni_feature_block(blocknumber, construct_block(SSaccessories.find_entry(features[MUTANT_HORNS], MUTANT_HORNS), SSaccessories.get_length(MUTANT_HORNS)))
		if(DNA_FRILLS_BLOCK)
			set_uni_feature_block(blocknumber, construct_block(SSaccessories.find_entry(features[MUTANT_FRILLS], MUTANT_FRILLS), SSaccessories.get_length(MUTANT_FRILLS)))
		if(DNA_SPINES_BLOCK)
			set_uni_feature_block(blocknumber, construct_block(SSaccessories.find_entry(features[MUTANT_SPINES], MUTANT_SPINES), SSaccessories.get_length(MUTANT_SPINES)))
		if(DNA_EARS_BLOCK)
			set_uni_feature_block(blocknumber, construct_block(SSaccessories.find_entry(features[MUTANT_EARS], MUTANT_EARS), SSaccessories.get_length(MUTANT_EARS)))
		if(DNA_MOTH_WINGS_BLOCK)
			set_uni_feature_block(blocknumber, construct_block(SSaccessories.find_entry(features["moth_wings"], "moth_wings"), SSaccessories.get_length("moth_wings")))
		if(DNA_MOTH_ANTENNAE_BLOCK)
			set_uni_feature_block(blocknumber, construct_block(SSaccessories.find_entry(features[MUTANT_MOTH_ANTENNAE], MUTANT_MOTH_ANTENNAE), SSaccessories.get_length(MUTANT_MOTH_ANTENNAE)))
		if(DNA_MOTH_MARKINGS_BLOCK)
			set_uni_feature_block(blocknumber, construct_block(SSaccessories.find_entry(features["moth_markings"], "moth_markings"), SSaccessories.get_length("moth_markings")))
		if(DNA_MUSHROOM_CAPS_BLOCK)
			set_uni_feature_block(blocknumber, construct_block(SSaccessories.find_entry(features["caps"], "caps"), SSaccessories.get_length("caps")))
		if(DNA_POD_HAIR_BLOCK)
			set_uni_feature_block(blocknumber, construct_block(SSaccessories.find_entry(features[MUTANT_POD_HAIR], MUTANT_POD_HAIR), SSaccessories.get_length(MUTANT_POD_HAIR)))
...
/datum/dna/proc/initialize_dna(newblood_type, skip_index = FALSE)
	...
	if(!skip_index) //I hate this
		generate_dna_blocks()
	features = SSaccessories.random_features()
	unique_features = generate_unique_features()
...
/mob/living/carbon/human/updateappearance(icon_update=1, mutcolor_update=0, mutations_overlay_update=0)
	...
	facial_hairstyle = SSaccessories.get_accessory(deconstruct_block(get_uni_identity_block(structure, DNA_FACIAL_HAIRSTYLE_BLOCK), SSaccessories.get_length("facial_hairstyle")))
	if(HAS_TRAIT(src, TRAIT_BALD))
		hairstyle = "Bald"
	else
		hairstyle = SSaccessories.get_accessory(deconstruct_block(get_uni_identity_block(structure, DNA_HAIRSTYLE_BLOCK), SSaccessories.get_length("hairstyle")))
	var/features = dna.unique_features
	if(dna.features["body_markings"])
		dna.features["body_markings"] = SSaccessories.get_accessory(deconstruct_block(get_uni_feature_block(features, DNA_LIZARD_MARKINGS_BLOCK), SSaccessories.get_length("body_markings")))
	if(dna.features["snout"])
		dna.features["snout"] = SSaccessories.get_accessory(deconstruct_block(get_uni_feature_block(features, DNA_SNOUT_BLOCK), SSaccessories.get_length(MUTANT_SNOUT)))
	if(dna.features["horns"])
		dna.features["horns"] = SSaccessories.get_accessory(deconstruct_block(get_uni_feature_block(features, DNA_HORNS_BLOCK), SSaccessories.get_length(MUTANT_HORNS)))
	if(dna.features["frills"])
		dna.features["frills"] = SSaccessories.get_accessory(deconstruct_block(get_uni_feature_block(features, DNA_FRILLS_BLOCK), SSaccessories.get_length(MUTANT_FRILLS)))
	if(dna.features["spines"])
		dna.features["spines"] = SSaccessories.get_accessory(deconstruct_block(get_uni_feature_block(features, DNA_SPINES_BLOCK), SSaccessories.get_length(MUTANT_SPINES)))
	if(dna.features[MUTANT_TAIL])
		dna.features[MUTANT_TAIL] = SSaccessories.get_accessory(deconstruct_block(get_uni_feature_block(features, DNA_TAIL_BLOCK), SSaccessories.get_length(MUTANT_TAIL)))
	if(dna.features["tail_lizard"])
		dna.features["tail_lizard"] = SSaccessories.get_accessory(deconstruct_block(get_uni_feature_block(features, DNA_LIZARD_TAIL_BLOCK), SSaccessories.get_length(MUTANT_LIZARD_TAIL)))
	if(dna.features["ears"])
		dna.features["ears"] = SSaccessories.get_accessory(deconstruct_block(get_uni_feature_block(features, DNA_EARS_BLOCK), SSaccessories.get_length(MUTANT_EARS)))
	if(dna.features["moth_wings"])
		var/genetic_value = SSaccessories.get_accessory(deconstruct_block(get_uni_feature_block(features, DNA_MOTH_WINGS_BLOCK), SSaccessories.get_length("moth_wings")))
		dna.features["original_moth_wings"] = genetic_value
		dna.features["moth_wings"] = genetic_value
	if(dna.features["moth_antennae"])
		var/genetic_value = SSaccessories.get_accessory(deconstruct_block(get_uni_feature_block(features, DNA_MOTH_ANTENNAE_BLOCK), SSaccessories.get_length(MUTANT_MOTH_ANTENNAE)))
		dna.features["original_moth_antennae"] = genetic_value
		dna.features["moth_antennae"] = genetic_value
	if(dna.features["moth_markings"])
		dna.features["moth_markings"] = SSaccessories.get_accessory(deconstruct_block(get_uni_feature_block(features, DNA_MOTH_MARKINGS_BLOCK), SSaccessories.get_length("moth_markings")))
	if(dna.features["caps"])
		dna.features["caps"] = SSaccessories.get_accessory(deconstruct_block(get_uni_feature_block(features, DNA_MUSHROOM_CAPS_BLOCK), SSaccessories.get_length("cap")))
	if(dna.features["pod_hair"])
		dna.features["pod_hair"] = SSaccessories.get_accessory(deconstruct_block(get_uni_feature_block(features, DNA_POD_HAIR_BLOCK), SSaccessories.get_length(MUTANT_POD_HAIR)))
