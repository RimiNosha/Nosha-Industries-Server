...
/datum/codex_entry/codex/New()
	mechanics_text = list(
		"The Codex is both an IC and OOC resource. ICly, it is as described; a space encyclopedia. You can use <b>Search-Codex <i>topic</i></b> to look something up, or you can click the links provided when examining some objects. ",
		"",
...
/datum/codex_entry/nexus
	name = "Nexus"
	mechanics_text = list("The place to start with <span codexlink='the codex'>The Codex</span>")
