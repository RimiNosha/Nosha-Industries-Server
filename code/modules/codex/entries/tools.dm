...
/datum/codex_entry/tool/crowbar
	...
	lore_text = "A crowbar of standard dimensions, able to be printed from most Noshan fabricators. Also found in varying sizes in various firefighting lockers, \
	because adding a button override to firelocks was deemed \"too easy\" to cause accidental deaths with."
...
/datum/codex_entry/tool/wrench
	name = "Wrench"
	lore_text = "A short adjustable wrench, just about simple enough for the average dullard to use."
...
/datum/codex_entry/tool/multitool
	name = "Multitool"
	lore_text = "To this day, nobody knows what the little green screen is for."
...
/datum/codex_entry/tool/wirecutters
	name = "Wirecutters"
	lore_text = "Wirecutters with a cheap plastic grip, not electrically insular."
...
/datum/codex_entry/tool/weldingtool
	...
	use_typesof = TRUE
	lore_text = "One of many implements that can cause burns, blindness, cancer, and other less-than-desirable ailments. Keep away from children."
